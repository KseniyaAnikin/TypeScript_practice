...
type UserReponseAfterApiRefactoring<T> = {
    data: T,
...
class SomeExternalApiAfterRefactoring {
    ...
    static async getUsers(): Promise<UserReponseAfterApiRefactoring<UserResponse[]>> {
        return {
    ...
    static async getSomeOther(): Promise<SomeOtherResponse[]> {
...
export class ApiProviderAfterRefactoring {
    getSomeOther(): Promise<SomeOtherResponse[]> {
        return SomeExternalApiAfterRefactoring.getSomeOther();
    }

    getUsers(): Promise<UserReponseAfterApiRefactoring<UserResponse[]>> {
        return SomeExternalApiAfterRefactoring.getUsers();
    }
